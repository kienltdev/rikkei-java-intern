...
public record InboundStatisticsRequest(

        @Parameter(
                description = "Filter by product type (e.g., 'Aircon', 'Spare_part'). Case-insensitive.",
                example = "Aircon"
        )
        @ValidEnum(
        ...
        @Parameter(
                description = "Filter by supplier country code (e.g., 'VN', 'TH'). Case-insensitive.",
                example = "VN"
        )
        @ValidEnum(
                enumClass = SupplierCd.class,
